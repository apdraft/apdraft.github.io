...
addbox.outerHTML += '<div class="company-box" style="margin-top: 30px;"><h2 class="company-name"><a href="/talent-pool">Talent Pool</a></h2><p class="company-tagline">Join our pool of DevRels</p><a href="/talent-pool"><lottie-player class="lazyload" src="https://cdn.jsdelivr.net/gh/apdraft/apdraft.github.io/join-talent-pool.json"  background="transparent"  speed="1"  style="width: auto; height: auto;"  loop  autoplay></lottie-player></a></div>';
}
